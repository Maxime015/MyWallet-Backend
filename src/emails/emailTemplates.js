export function createWelcomeEmailTemplate(name) {
  ...
  <body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f5f5f5;">
    <div style="background: linear-gradient(to right, #36D1DC, #5B86E5); padding: 30px; text-align: center; border-radius: 12px 12px 0 0;">
      ...
      <h1 style="color: white; margin: 0; font-size: 28px; font-weight: 500;">Welcome to MyWallet!</h1>
    </div>
    <div style="background-color: #ffffff; padding: 35px; border-radius: 0 0 12px 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
      <p style="font-size: 18px; color: #5B86E5;"><strong>Hello ${name},</strong></p>
      <p>We're excited to have you join our messaging platform! MyWallet connects you with friends, family, and colleagues in real-time, no matter where they are.</p>
      ...
      <div style="background-color: #f8f9fa; padding: 25px; border-radius: 10px; margin: 25px 0; border-left: 4px solid #36D1DC;">
        ...
        <ul style="padding-left: 20px; margin: 0;">
          <li style="margin-bottom: 10px;">Sign up and log in to your account</li>
          <li style="margin-bottom: 10px;">Track your daily transactions effortlessly</li>
          <li style="margin-bottom: 10px;">Manage all your subscriptions in one place</li>
          <li style="margin-bottom: 0;">Explore your upcoming payments with the financial calendar</li>
        </ul>
      </div>
      ...
      <p style="margin-top: 25px; margin-bottom: 0;">Best regards,<br>The MyWallet Team</p>
    </div>
